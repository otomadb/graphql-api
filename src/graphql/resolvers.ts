...
import { TagNameModel } from '../models/tag_name.js';
import { TagParentModel } from '../models/tag_parent.js';
import { TagModel } from '../models/tag.js';
import { VideoThumbnailModel } from '../models/video_thumbnail.js';
import { VideoTitleModel } from '../models/video_title.js';
...
export type ResolversTypes = {
  ...
  NiconicoSource: ResolverTypeWrapper<Omit<NiconicoSource, 'video'> & { video?: Maybe<ResolversTypes['Video']> }>;
  NiconicoVideoSource: ResolverTypeWrapper<NiconicoVideoSource>;
  Query: ResolverTypeWrapper<{}>;
  RegisterTagInput: RegisterTagInput;
  RegisterTagPayload: ResolverTypeWrapper<Omit<RegisterTagPayload, 'tag'> & { tag: ResolversTypes['Tag'] }>;
  ...
  RegisterVideoPayload: ResolverTypeWrapper<Omit<RegisterVideoPayload, 'video'> & { video: ResolversTypes['Video'] }>;
  SearchTagsResult: ResolverTypeWrapper<Omit<SearchTagsResult, 'result'> & { result: Array<ResolversTypes['SearchTagsResultItem']> }>;
  SearchTagsResultItem: ResolverTypeWrapper<Omit<SearchTagsResultItem, 'tag'> & { tag: ResolversTypes['Tag'] }>;
  SearchVideosResult: ResolverTypeWrapper<Omit<SearchVideosResult, 'result'> & { result: Array<ResolversTypes['SearchVideosResultItem']> }>;
  SearchVideosResultItem: ResolverTypeWrapper<Omit<SearchVideosResultItem, 'video'> & { video: ResolversTypes['Video'] }>;
  SortOrder: SortOrder;
  ...
  TagParent: ResolverTypeWrapper<TagParentModel>;
  TagRegisterHistoryItem: ResolverTypeWrapper<Omit<TagRegisterHistoryItem, 'tag'> & { tag: ResolversTypes['Tag'] }>;
  TagType: TagType;
  TagVideoInput: TagVideoInput;
  UntagVideoInput: UntagVideoInput;
  User: ResolverTypeWrapper<User>;
  Video: ResolverTypeWrapper<VideoModel>;
  VideoAddNiconicoSourceHistoryItem: ResolverTypeWrapper<Omit<VideoAddNiconicoSourceHistoryItem, 'niconico' | 'video'> & { niconico: ResolversTypes['NiconicoSource'], video: ResolversTypes['Video'] }>;
  VideoAddTagHistoryItem: ResolverTypeWrapper<Omit<VideoAddTagHistoryItem, 'tag' | 'video'> & { tag: ResolversTypes['Tag'], video: ResolversTypes['Video'] }>;
  VideoAddThumbnailHistoryItem: ResolverTypeWrapper<Omit<VideoAddThumbnailHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoAddTitleHistoryItem: ResolverTypeWrapper<Omit<VideoAddTitleHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoChangePrimaryThumbnailHistoryItem: ResolverTypeWrapper<Omit<VideoChangePrimaryThumbnailHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoChangePrimaryTitleHistoryItem: ResolverTypeWrapper<Omit<VideoChangePrimaryTitleHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoCollection: ResolverTypeWrapper<Omit<VideoCollection, 'nodes'> & { nodes: Array<ResolversTypes['Video']> }>;
  VideoDeleteTagHistoryItem: ResolverTypeWrapper<Omit<VideoDeleteTagHistoryItem, 'tag' | 'video'> & { tag: ResolversTypes['Tag'], video: ResolversTypes['Video'] }>;
  VideoDeleteThumbnailHistoryItem: ResolverTypeWrapper<Omit<VideoDeleteThumbnailHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoDeleteTitleHistoryItem: ResolverTypeWrapper<Omit<VideoDeleteTitleHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  ...
  VideoRegisterHistoryItem: ResolverTypeWrapper<Omit<VideoRegisterHistoryItem, 'video'> & { video: ResolversTypes['Video'] }>;
  VideoSource: ResolversTypes['NiconicoVideoSource'] | ResolversTypes['YoutubeVideoSource'];
  VideoThumbnail: ResolverTypeWrapper<VideoThumbnailModel>;
  VideoTitle: ResolverTypeWrapper<VideoTitleModel>;
...
export type ResolversParentTypes = {
  ...
  Int: Scalars['Int'];
  Mutation: {};
  NiconicoSource: Omit<NiconicoSource, 'video'> & { video?: Maybe<ResolversParentTypes['Video']> };
  NiconicoVideoSource: NiconicoVideoSource;
  Query: {};
  RegisterTagInput: RegisterTagInput;
  RegisterTagPayload: Omit<RegisterTagPayload, 'tag'> & { tag: ResolversParentTypes['Tag'] };
  RegisterVideoInput: RegisterVideoInput;
  RegisterVideoInputSource: RegisterVideoInputSource;
  RegisterVideoPayload: Omit<RegisterVideoPayload, 'video'> & { video: ResolversParentTypes['Video'] };
  SearchTagsResult: Omit<SearchTagsResult, 'result'> & { result: Array<ResolversParentTypes['SearchTagsResultItem']> };
  SearchTagsResultItem: Omit<SearchTagsResultItem, 'tag'> & { tag: ResolversParentTypes['Tag'] };
  SearchVideosResult: Omit<SearchVideosResult, 'result'> & { result: Array<ResolversParentTypes['SearchVideosResultItem']> };
  SearchVideosResultItem: Omit<SearchVideosResultItem, 'video'> & { video: ResolversParentTypes['Video'] };
  ...
  TagParent: TagParentModel;
  TagRegisterHistoryItem: Omit<TagRegisterHistoryItem, 'tag'> & { tag: ResolversParentTypes['Tag'] };
  TagVideoInput: TagVideoInput;
  UntagVideoInput: UntagVideoInput;
  User: User;
  Video: VideoModel;
  VideoAddNiconicoSourceHistoryItem: Omit<VideoAddNiconicoSourceHistoryItem, 'niconico' | 'video'> & { niconico: ResolversParentTypes['NiconicoSource'], video: ResolversParentTypes['Video'] };
  VideoAddTagHistoryItem: Omit<VideoAddTagHistoryItem, 'tag' | 'video'> & { tag: ResolversParentTypes['Tag'], video: ResolversParentTypes['Video'] };
  VideoAddThumbnailHistoryItem: Omit<VideoAddThumbnailHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  VideoAddTitleHistoryItem: Omit<VideoAddTitleHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  VideoChangePrimaryThumbnailHistoryItem: Omit<VideoChangePrimaryThumbnailHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  VideoChangePrimaryTitleHistoryItem: Omit<VideoChangePrimaryTitleHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  VideoCollection: Omit<VideoCollection, 'nodes'> & { nodes: Array<ResolversParentTypes['Video']> };
  VideoDeleteTagHistoryItem: Omit<VideoDeleteTagHistoryItem, 'tag' | 'video'> & { tag: ResolversParentTypes['Tag'], video: ResolversParentTypes['Video'] };
  VideoDeleteThumbnailHistoryItem: Omit<VideoDeleteThumbnailHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  VideoDeleteTitleHistoryItem: Omit<VideoDeleteTitleHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
  ...
  VideoHistoryOrder: VideoHistoryOrder;
  VideoRegisterHistoryItem: Omit<VideoRegisterHistoryItem, 'video'> & { video: ResolversParentTypes['Video'] };
