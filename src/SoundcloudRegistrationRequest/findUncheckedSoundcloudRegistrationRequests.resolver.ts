...
import { SoundcloudRegistrationRequestConnectionDTO } from "./SoundcloudRegistrationRequestConnection.dto.js";

export const resolverFindUncheckedSoundcloudRegistrationRequests = ({
  prisma,
  logger,
  ...
  (async (_, { input: { orderBy: unparsedOrderBy, ...unparsedConnectionArgs } }, { currentUser: ctxUser }, info) => {
    ...
    ).then((c) => SoundcloudRegistrationRequestConnectionDTO.fromPrisma(c));
  }) satisfies QueryResolvers["findUncheckedSoundcloudRegistrationRequests"];
