...
import { SoundcloudRegistrationRequestAcceptingDTO } from "./SoundcloudRegistrationRequestAccepting.dto.js";

export const resolverSoundcloudRegistrationRequestAcceptingNotification = ({
  prisma,
  userService,
  logger,
  ...
  }) satisfies Resolvers["SoundcloudRegistrationRequestAcceptingNotification"];
