...
await Deno.writeTextFile(new URL("./private.txt", import.meta.url), btoa(privateKeyPem));
await Deno.writeTextFile(new URL("./public.txt", import.meta.url), btoa(publicKeyPem));
